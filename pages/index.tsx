...
export default function Home() {
  const postManagerContract = "0xa944D96F0384e19950e523809E6F294cAF4CEd57"; //postManager smart contract address
    ...
    return (
      <div className={styles.dropZoneStyle} {...getRootProps()}>
        ...
        {isDragActive ? (
          ...
          <p>
            Drag and drop your Image file here, or click to select file ((Only *.jpeg, *jpg and
            *.png images will be accepted))
          </p>
        )}
      </div>
    );
